...
def ppo_step(env: mujoco_playground.MjxEnv,
    ...
    pre_rollout_module_state = nnx.state(training_state.networks, nnx.Not(nnx.Param))
    ...
    if LoggingLevel.ASSERTS in logging_level:
        post_rollout_module_state = nnx.state(training_state.networks, nnx.Not(nnx.Param))
